...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1940.0, 142.0, 112.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1901.0, 186.0, 74.0, 22.0 ],
					"text" : "unpack f f f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1901.0, 137.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "float", "float", "float", "float" ],
					"patching_rect" : [ 1312.0, 189.0, 74.0, 22.0 ],
					"text" : "unpack f f f f"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1315.0, 61.0, 99.0, 20.0 ],
					"text" : "filter params"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1282.0, 63.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1045.0, 189.0, 67.0, 22.0 ],
					"text" : "unpack f f f"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1032.0, 50.0, 99.0, 20.0 ],
					"text" : "delay params"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 999.0, 52.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2349.0, 683.0, 150.0, 33.0 ],
					"text" : "adding here so it's easier to scroll "
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1897.0, 356.0, 351.0, 141.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 1300.0, 328.0, 586.0, 197.0 ],
					"varname" : "bp.LPF",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 1045.0, 339.5, 233.0, 135.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 442.0, 323.0, 569.0, 168.0 ],
					"varname" : "bp.Flanger",
					"viewvisibility" : 1
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 172.5, 589.5, 397.5, 589.5 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 424.5, 589.5, 487.0, 589.5 ],
					"source" : [ "obj-2", 1 ]
				}
