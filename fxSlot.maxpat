...
,
		"classnamespace" : "box",
		"rect" : [ 509.0, -1140.0, 1298.0, 877.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 991.0, 293.5, 150.0, 20.0 ],
					"text" : "NOT STEREO :("
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 962.0, 323.0, 304.0, 116.0 ],
					"varname" : "bp.LPF",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 442.0, 323.0, 190.0, 116.0 ],
					"varname" : "bp.Flanger",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 456.5, 743.0, 78.0, 22.0 ],
					"text" : "selector~ 5 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 367.0, 743.0, 78.0, 22.0 ],
					"text" : "selector~ 5 1"
				}
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "BYPASS", "REVERB", "FLANGER", "DELAY", "LADDER" ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 82.5, 514.5, 388.300000000000011, 514.5 ],
					"order" : 0,
					"source" : [ "obj-47", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 451.5, 590.5, 411.899999999999977, 590.5 ],
					"source" : [ "obj-58", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 622.5, 590.5, 501.399999999999977, 590.5 ],
					"source" : [ "obj-58", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 971.5, 590.5, 435.5, 590.5 ],
					"order" : 1,
					"source" : [ "obj-72", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 971.5, 590.5, 525.0, 590.5 ],
					"order" : 0,
					"source" : [ "obj-72", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-58::obj-1" : [ "Width", "Width", 0 ],
			"obj-58::obj-2" : [ "Rate", "Rate", 0 ],
